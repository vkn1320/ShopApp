        ...
        <div class="section"> 
            ...
            <div class="pmd-card pmd-z-depth">
                <div class="pmd-card-body">
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="lead">ОТПРАВИТЬ УВЕДОМЛЕНИЕ</div>
                        </div>
                    </div>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <div class="form-group pmd-textfield">
                                <label for="regular1" class="control-label">Большое Изображение ( jpg / png) *</label>
                    ...
                    <div class="group-fields clearfix row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="form-group pmd-textfield">
                                ...
                                <input type="text" name="external_link" id="external_link" class="form-control" placeholder="https://www.youtube.com/c/ErikDeliyev" value="<?php echo $data['link']; ?>">
                            </div>
                        </div>
                    </div>
                ...
                <div class="pmd-card-actions">
                    <p align="right">
                    <button type="submit" class="btn pmd-ripple-effect btn-danger" name="submit">Отправить</button>
                    </p>
                </div>
